        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                	<div class="col-lg-4">
                		<form role="form" action="${ctx}/dictionary/add" method="post" class="form-horizontal">
								...
								<div class="form-group input-group">
									...
									<input type="text" value="${dictionaryType.code}" name="type" class="form-control" />
								</div>
								<div class="form-group input-group">
									<span class="input-group-addon">上级父ID：</span>
									<input type="text" value="${dictionaryType.id}" name="pid" class="form-control" />
								</div>
								<div class="form-group input-group">
